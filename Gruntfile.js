module.exports = function(grunt) {
  ...
  grunt.initConfig({
    pkg: grunt.file.readJSON('package.json'), // reads the packages and other things inside that file
      concat: {
        // configure the concatenation task (info / details come from the repository on Github)
        dist: {
          src: [
            'js/my_modules/*.js',
            'js/main.js'
